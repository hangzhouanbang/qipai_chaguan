...
import com.anbang.qipai.chaguan.msg.channel.sink.DoudizhuResultSink;
...
import com.anbang.qipai.chaguan.plan.bean.historicalresult.puke.DoudizhuJuPlayerResult;
import com.anbang.qipai.chaguan.plan.bean.historicalresult.puke.DoudizhuPanPlayerResult;
				...
				if (table != null) {
					...
					if (playerList != null) {
						...
						((List) playerList).forEach((juPlayerResult) -> {
							...
							DoudizhuJuPlayerResult pr = new DoudizhuJuPlayerResult((Map) juPlayerResult);
